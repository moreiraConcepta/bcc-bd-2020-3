...
1. Criar um repositório necessariamente '**publico**' de nome **bd-2020-2**, exatamente como assim grafado, ou seja, letras minúsculas e hífen para separar **bd** do número **2020**, e outro hífen para separar este número do dígito **2**. 
